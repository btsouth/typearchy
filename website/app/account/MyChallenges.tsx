...
export default function MyChallenges() {
  ...
  return <section className="my-challenges"><h2>Your challenges</h2><p>Every passage you saved. Links work right away; the public library lists a passage after review.</p>
    ...
    {challenges?.map(challenge => <article key={challenge.slug} className="moderation-entry">
      ...
      <p>{challenge.language} · {challenge.visibility === 'hidden' ? 'Only you can open it' : challenge.moderation === 'pending' ? challenge.visibility === 'public' ? 'Shareable by link · library listing awaiting review' : 'Shareable by link' : challenge.moderation === 'rejected' ? 'Not approved · only you can open it' : challenge.visibility === 'public' ? 'In the public library' : 'Shareable by link'}</p>
